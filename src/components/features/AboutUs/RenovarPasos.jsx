        ...
        <section className={styles.container}>
            ...
            <div className={styles.stepsContainer}>
                <div className={styles.stepItem}>
                    <h3 className={styles.stepTitle}>Paso 1: Nos Contas Tu Idea</h3>
                ...
                <div className={styles.stepItem}>
                    <h3 className={styles.stepTitle}>Paso 2: Diseño y Planificación</h3>
                    <p className={styles.stepDescription}>
                ...
                <div className={styles.stepItem}>
                    <h3 className={styles.stepTitle}>Paso 3: Construcción</h3>
                    <p className={styles.stepDescription}>
