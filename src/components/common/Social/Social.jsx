...
export function Social() {
  return (
    <div className={`${styles.socialColumn} ${styles.column}`}>
        ...
        <a href="https://www.tiktok.com/@piedraconstrucciones" target="_blank" rel="noopener noreferrer"><img src="/images/logos/tiktok-logo.svg" alt="YouTube" width="24" height="24" loading="lazy" /></a>        
