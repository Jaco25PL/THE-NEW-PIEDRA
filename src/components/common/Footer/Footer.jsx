    ...
    <footer className={styles.footer}>
      <div className={`${styles.footerSection} ${styles.footerLeft}`}>
        <div className={styles.footerLeftTop}>
          <a
            href="https://api.whatsapp.com/send?phone=59893595589"
            target="blank"
          >
            +598 093 595 589
          </a>
          <span>|</span>
          <a href="#faq" onClick={scrollToFAQ}>
            Preguntas Frecuentes
          </a>
          <span>|</span>
          <a href="mailto:piedraconstr.uy@gmail.com" target="blank">
            piedraconstr.uy@gmail.com
          </a>
        </div>
      ...
      <div className={`${styles.footerSection} ${styles.footerRight}`}>
        <p>
          Queremos ayudarte a construir o transformar el hogar que siempre
          soñastes
        </p>
      </div>
